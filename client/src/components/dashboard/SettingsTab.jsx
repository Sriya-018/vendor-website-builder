...
function SettingsTab({ businessId, businessData, onUpdate, refreshData, websites, selectedWebsite, setSelectedWebsite }) {
 ...
 <label className="cursor-pointer bg-white dark:bg-[#13121A] border border-slate-300 dark:border-slate-700/60 text-slate-600 dark:text-slate-400 px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-100 dark:hover:bg-slate-700 dark:bg-slate-800 transition-colors">
 Upload New Logo
