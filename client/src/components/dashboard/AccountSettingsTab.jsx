  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-slate-600 dark:text-slate-500 text-sm">Manage your profile, adjust interface themes, and set email preferences.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6 lg:col-span-1">
          ...
          <div className="bg-white dark:bg-[#13121A] rounded-2xl border border-slate-200 dark:border-slate-800/60 p-5 shadow-lg space-y-4">
              ...
              <button
                ...
                className={`flex flex-col items-center gap-2 py-3 rounded-xl border transition-all text-xs font-semibold ${
                  theme === 'dark'
                    ...
                    : 'bg-slate-50 dark:bg-[#09080E] border-slate-200 dark:border-slate-800/60 text-slate-600 dark:text-slate-400 hover:text-slate-200'
                }`}
              >
          ...
          <div className="bg-white dark:bg-[#13121A] rounded-2xl border border-slate-200 dark:border-slate-800/60 p-6 shadow-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between py-2">
                <div>
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white">Email alerts on new inquiries</h4>
                  <p className="text-xs text-slate-600 dark:text-slate-500">Receive an email instantly when customers submit WhatsApp checkout logs.</p>
                </div>
                <button
                  type="button"
                  ...
                  className={`w-10 h-5 rounded-full p-0.5 transition-colors duration-200 focus:outline-none ${
                    notificationPrefs.emailInquiries ? 'bg-purple-600' : 'bg-slate-100 dark:bg-slate-800'
                  }`}
                >
              ...
              <div className="flex items-center justify-between py-2 border-t border-slate-200 dark:border-slate-850">
                <div>
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white">WhatsApp logs mirroring</h4>
                  <p className="text-xs text-slate-600 dark:text-slate-500">Send copy of client checkout orders to linked business numbers.</p>
                </div>
                <button
                  type="button"
                  onClick={() => handleTogglePreference('whatsappLogs')}
                  className={`w-10 h-5 rounded-full p-0.5 transition-colors duration-200 focus:outline-none ${
                    notificationPrefs.whatsappLogs ? 'bg-purple-600' : 'bg-slate-100 dark:bg-slate-800'
                  }`}
                >
                  <div className={`w-4 h-4 rounded-full bg-white transition-transform duration-200 transform ${
