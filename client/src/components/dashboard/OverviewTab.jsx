              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-800/60 text-sm">
                  {websites.map((website, index) => {
                    ...
                    return (
                      <tr key={website._id} className="hover:bg-slate-50 dark:hover:bg-slate-100 dark:hover:bg-slate-100 dark:bg-slate-800/20 transition-colors">
                          ...
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <div className="relative inline-block text-left">
                              <button
                                ...
                                className="p-2 hover:bg-slate-100 dark:hover:bg-slate-100 dark:bg-slate-800 rounded-lg text-slate-600 dark:text-slate-500 hover:text-slate-700 dark:text-slate-300 transition-colors border border-transparent hover:border-slate-300 dark:border-slate-700"
                                title="Actions"
                              >
                                <FaEllipsisV />
                              </button>
                                ...
                                <>
                                  ...
                                  <div className="absolute right-0 mt-1 w-44 bg-white dark:bg-[#13121A] border border-slate-300 dark:border-slate-700/60 rounded-xl shadow-2xl shadow-black/50 z-40 py-1.5 text-left text-xs">
                                    <button
                                      ...
                                      className="w-full px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-100 dark:hover:bg-slate-100 dark:bg-slate-800/60 text-slate-700 dark:text-slate-300 font-semibold flex items-center gap-2"
                                    >
