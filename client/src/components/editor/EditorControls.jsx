    ...
    <div className="flex flex-col h-full bg-white text-sm">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <Section id="template" title="1. Layout Template" icon={FaGripHorizontal}>
          {website ? (
            <div className="bg-gradient-to-r from-pink-50 via-rose-50/50 to-pink-50 border border-pink-100 rounded-2xl p-5 text-left shadow-sm">
              ...
              <div className="mt-4 p-3 bg-white border border-pink-100 rounded-xl text-xs text-pink-900 leading-relaxed font-medium">
        ...
        <Section id="sectionsDesigner" title="Layout & Section Order" icon={FaGripHorizontal}>
          <p className="text-xs text-gray-500 mb-3 font-medium">Drag sections by the grid handle or use arrows to arrange your landing page layout.</p>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <span className="font-bold text-gray-700 capitalize text-xs tracking-wide">{key} Section</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <button 
                      ...
                      onClick={() => move('up')} 
                      disabled={idx <= 0}
                      className="p-1 hover:bg-gray-200 text-gray-500 rounded disabled:opacity-20 transition-colors"
                      title="Move Up"
                    >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                  <span className="font-bold text-gray-800 text-xs uppercase tracking-wider">1. Key Ingredients Highlight</span>
                  <button 
                    onClick={() => {
                ...
                <div className="space-y-3 max-h-[250px] overflow-y-auto pr-1">
                  {(config.beauty?.ingredients || []).map((item, idx) => (
                    <div key={item.id || idx} className="p-3 bg-gray-50 border border-gray-150 rounded-xl space-y-2 relative">
                      <button 
                        onClick={() => {
                          const currentIng = config.beauty?.ingredients || [];
                        ...
                        className="absolute top-2 right-2 text-gray-400 hover:text-red-500 font-bold text-sm w-5 h-5 flex items-center justify-center rounded-full hover:bg-gray-200"
                      ...
                      <div className="flex gap-2">
                        <div className="w-12">
                          <label className="block text-[9px] font-bold text-gray-400 uppercase mb-0.5">Icon</label>
                          <input 
                            type="text"
                            value={item.icon}
                            onChange={(e) => {
                            ...
                            className="w-full p-1 bg-white border border-gray-200 rounded text-center text-sm outline-none focus:border-pink-500"
                          />
                        </div>
                        <div className="flex-1">
                          <label className="block text-[9px] font-bold text-gray-400 uppercase mb-0.5">Ingredient Name</label>
                          <input 
                            type="text"
                            value={item.name}
                            onChange={(e) => {
                            ...
                            className="w-full p-1 bg-white border border-gray-200 rounded text-xs font-semibold text-gray-800 outline-none focus:border-pink-500"
                          />
                        </div>
                      </div>
                      <div>
                        ...
                        <textarea 
                          ...
                          rows={2}
                          className="w-full p-1.5 bg-white border border-gray-200 rounded text-[11px] text-gray-600 resize-none outline-none focus:border-pink-500"
                        />
                      </div>
                    </div>
                  ))}
                  {(config.beauty?.ingredients || []).length === 0 && (
                    <p className="text-gray-400 text-xs italic text-center py-2">No ingredients configured. Add one above.</p>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-3 pt-2 border-t border-gray-150">
                <span className="font-bold text-gray-800 text-xs uppercase tracking-wider block">2. Daily Skincare Routine Steps</span>
                
                <div className="space-y-2">
                  <label className="block text-[10px] font-bold text-gray-500 uppercase">Routine Title</label>
                  <input 
                    type="text"
                    ...
                    className="w-full p-2 bg-gray-50 border border-gray-200 rounded-lg text-xs font-bold text-gray-800 outline-none focus:border-pink-500"
                  />
                </div>

                <div className="space-y-3 max-h-[250px] overflow-y-auto pr-1">
                  {(config.beauty?.routine?.steps || []).map((step, idx) => (
                    <div key={step.id || idx} className="p-3 bg-gray-50 border border-gray-150 rounded-xl space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <input 
                          ...
                          className="flex-1 p-1 bg-white border border-gray-200 rounded text-xs font-semibold text-gray-800 outline-none focus:border-pink-500"
                          placeholder="Step Title"
                        />
                      </div>
                      <div>
                        <label className="block text-[9px] font-bold text-gray-400 uppercase mb-0.5">Instruction Text</label>
                        <textarea 
                          value={step.text}
                          onChange={(e) => {
                            const currentRoutine = config.beauty?.routine || {};
        ...
        <Section id="themeColor" title="2. Theme Color" icon={FaPalette}>
          <div className="space-y-4">
            <div className="flex flex-wrap gap-3">
              {THEMES.map(t => (
                <button
                  ...
                  className={`w-10 h-10 rounded-full border-4 shadow-sm transition-transform ${config.themeColor === t.color ? 'border-purple-250 scale-110' : 'border-transparent hover:scale-105'}`}
            ...
            <div className="flex items-center gap-3 pt-3 border-t border-gray-100">
              <label className="text-xs font-bold text-gray-700">Custom Brand Accent:</label>
              <div className="flex items-center gap-2">
                <input 
                  type="color" 
                ...
                />
                <span className="text-xs uppercase font-mono font-bold text-gray-600">{config.themeColor || '#2563eb'}</span>
              </div>
            </div>
          </div>
        </Section>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select 
                ...
                className="w-full border-gray-300 rounded-md shadow-sm p-2 bg-gray-50 border font-semibold text-gray-800"
              >
        ...
        <Section id="navbar" title="4. Navigation Bar" icon={FaBars}>
           <div className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-gray-700 mb-1">Store Name / Logo Text</label>
              <input 
              ...
              />
              <p className="text-[10px] text-gray-400 mt-1 font-medium">Changes the brand text displayed in the header navigation bar.</p>
            </div>
        ...
        <Section id="header" title="5. Header & Hero" icon={FaImage}>
          <div className="space-y-4">
              ...
              {config.header.announcement.show && (
                <>
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-gray-400 font-bold text-[9px] uppercase">Announcement Text</span>
                    <button
                      type="button"
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <label className="block text-xs font-bold text-gray-700">Hero Heading</label>
                <button
                  type="button"
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <label className="block text-xs font-bold text-gray-700">Hero Subheading</label>
                <button
                  type="button"
        ...
        <Section id="faqSettings" title="10. FAQs Management" icon={FaListAlt}>
          <div className="space-y-4 text-xs">
            <div className="flex justify-between items-center border-b border-gray-100 pb-2">
              <span className="font-bold text-gray-800 uppercase tracking-wider">Configure FAQ List</span>
              <button 
                type="button"
                onClick={() => {
            ...
            <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1">
              {(config.faq?.questions || []).map((faq, idx) => (
                <div key={faq.id || idx} className="p-3 bg-gray-50 border border-gray-200 rounded-xl space-y-2 relative">
                  <button 
                    type="button"
                    onClick={() => {
                      const currentFaq = config.faq?.questions || [];
                  ...
                  <div>
                    <label className="block text-[9px] font-bold text-gray-400 uppercase mb-0.5">Question</label>
                    <input 
                      type="text"
                      value={faq.question}
                      onChange={(e) => {
                      ...
                      className="w-full p-1.5 bg-white border border-gray-200 rounded text-xs font-bold text-gray-800 outline-none focus:border-blue-500"
                    />
                  </div>
                  <div>
                    <label className="block text-[9px] font-bold text-gray-400 uppercase mb-0.5">Answer</label>
                    <textarea 
                      value={faq.answer}
                      onChange={(e) => {
                        const currentFaq = config.faq?.questions || [];
                      ...
                      rows={2}
                      className="w-full p-1.5 bg-white border border-gray-200 rounded text-xs text-gray-655 resize-none outline-none focus:border-blue-500"
                    />
                  </div>
                </div>
              ))}
              {(config.faq?.questions || []).length === 0 && (
                <p className="text-gray-400 text-xs italic text-center py-2">No FAQs configured. Add one above.</p>
              )}
            </div>
          </div>
        </Section>
        ...
        <Section id="testimonialsSettings" title="11. Testimonials & Reviews" icon={FaListAlt}>
          <div className="space-y-4 text-xs">
            <div className="flex justify-between items-center border-b border-gray-100 pb-2">
              <span className="font-bold text-gray-800 uppercase tracking-wider">Configure Customer Reviews</span>
              <button 
                type="button"
                onClick={() => {
            ...
            <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1">
              {(config.testimonials?.list || []).map((item, idx) => (
                <div key={item.id || idx} className="p-3 bg-gray-50 border border-gray-200 rounded-xl space-y-2 relative">
                  <button 
                    type="button"
                    onClick={() => {
                      const currentTest = config.testimonials?.list || [];
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="block text-[9px] font-bold text-gray-400 uppercase mb-0.5">Name</label>
                      <input 
                        type="text"
                        value={item.name}
                        onChange={(e) => {
                    ...
                    <div>
                      <label className="block text-[9px] font-bold text-gray-400 uppercase mb-0.5">Role / Badge</label>
                      <input 
                        type="text"
                        value={item.role}
                        onChange={(e) => {
                        ...
                        className="w-full p-1.5 bg-white border border-gray-200 rounded text-xs text-gray-805 outline-none focus:border-blue-500"
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-2 items-center">
                    <div>
                      <label className="block text-[9px] font-bold text-gray-400 uppercase mb-0.5">Rating (1-5 Stars)</label>
                      <select
                        value={item.rating}
                        onChange={(e) => {
                          const currentTest = config.testimonials?.list || [];
                        ...
                        className="w-full p-1.5 bg-white border border-gray-200 rounded text-xs font-bold outline-none focus:border-blue-500"
                      >
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      rows={2}
                      className="w-full p-1.5 bg-white border border-gray-200 rounded text-xs text-gray-600 resize-none outline-none focus:border-blue-500"
                    />
                  </div>
                </div>
              ))}
              {(config.testimonials?.list || []).length === 0 && (
                <p className="text-gray-400 text-xs italic text-center py-2">No reviews configured. Add one above.</p>
              )}
            </div>
          </div>
        </Section>
        ...
        <Section id="gallerySettings" title="12. Photo Gallery" icon={FaImage}>
          <div className="space-y-4 text-xs">
            <div className="flex justify-between items-center border-b border-gray-100 pb-2">
              <span className="font-bold text-gray-800 uppercase tracking-wider">Gallery Images</span>
              <button 
                type="button"
                onClick={() => {
            ...
            <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1">
              {(config.gallery?.images || []).map((img, idx) => (
                <div key={idx} className="p-3 bg-gray-50 border border-gray-200 rounded-xl space-y-2 relative flex items-center gap-3">
                  <div className="w-12 h-12 rounded-lg bg-slate-100 border overflow-hidden flex-shrink-0">
                    <img src={img} className="w-full h-full object-cover" alt="" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <label className="block text-[9px] font-bold text-gray-400 uppercase mb-0.5">Image URL</label>
                    <input 
                      type="text"
                      value={img}
                      onChange={(e) => {
                      ...
                      className="w-full p-1 bg-white border border-gray-200 rounded text-[10px] text-gray-800 outline-none focus:border-blue-500 font-mono"
                    />
                  </div>
                  <button 
                    type="button"
                    ...
                    className="text-gray-400 hover:text-red-500 font-bold text-sm w-7 h-7 flex items-center justify-center rounded-full hover:bg-gray-200 flex-shrink-0"
                    title="Delete Image"
                  >
                    ×
                  </button>
              ...
              {(config.gallery?.images || []).length === 0 && (
                <p className="text-gray-400 text-xs italic text-center py-2">No gallery images. Add one above.</p>
              )}
            </div>
          </div>
        </Section>
        ...
        <Section id="trust" title="15. Trust & Social Proof" icon={FaShieldAlt}>
          <div className="space-y-3 p-3 bg-gray-50 rounded-lg border border-gray-250">
            <div className="flex items-center justify-between">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="space-y-3">
              {(config.customPages || []).map(page => {
                ...
                return (
                  <div key={page.id} className="p-3 bg-gray-50 rounded-xl border border-gray-200 shadow-sm space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="font-bold text-gray-800 text-xs block">{page.title}</span>
                        ...
                        {page.layout === 'text' ? (
                          <div className="space-y-3">
                            <div>
                              ...
                              <input 
                                ...
                                className="w-full p-2 bg-white border border-gray-200 rounded-xl text-xs outline-none focus:ring-1 focus:ring-indigo-500"
                                placeholder="https://picsum.photos/seed/about/1200/600"
                              />
                            </div>
                            <div>
                              <label className="block text-gray-500 font-bold mb-1 uppercase text-[9px]">Page Rich Text Content</label>
                              <textarea 
                                value={page.desc || ''}
                                onChange={(e) => {
                          ...
                          <div className="space-y-3">
                            <div className="flex justify-between items-center pb-1">
                              <span className="font-bold text-gray-600 text-[10px]">Cards List ({page.items.length})</span>
                              <button
                                type="button"
                                onClick={() => {
                            ...
                            <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1">
                              {(page.items || []).map((item, idx) => (
                                <div key={item.id || idx} className="p-2.5 bg-white border border-gray-200 rounded-xl relative space-y-2.5">
                                  <button
                                    type="button"
                                    onClick={() => {
                                    ...
                                    className="absolute top-1.5 right-1.5 text-gray-400 hover:text-red-500 text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full hover:bg-gray-50 z-10"
                                    title="Delete Card"
                                  >
                                    ×
                                  </button>
                                  ...
                                  <div className="grid grid-cols-2 gap-2">
                                    <div>
                                      <label className="block text-gray-400 font-bold mb-0.5 text-[9px] uppercase">Card Title</label>
                                      <input 
                                        type="text"
                                        value={item.name || ''}
                                        onChange={(e) => {
                                        ...
                                        className="w-full p-1 border border-gray-150 rounded text-[11px] outline-none focus:border-indigo-500"
                                      />
                                    </div>
                                    
                                    {page.layout === 'menu' && (
                                      <div>
                                        <label className="block text-gray-400 font-bold mb-0.5 text-[9px] uppercase">Price (₹)</label>
                                        <input 
                                          type="text"
                                          value={item.price || ''}
                                          onChange={(e) => {
                                    ...
                                    {page.layout === 'specials' && (
                                      <div>
                                        <label className="block text-gray-400 font-bold mb-0.5 text-[9px] uppercase">Promo Badge</label>
                                        <input 
                                          type="text"
                                          value={item.badge || ''}
                                          onChange={(e) => {
                                    ...
                                    {(page.layout === 'menu' || page.layout === 'features') && (
                                      <div>
                                        <label className="block text-gray-400 font-bold mb-0.5 text-[9px] uppercase">Icon / Emoji</label>
                                        <input 
                                          type="text"
                                          value={item.icon || ''}
                                          onChange={(e) => {
                                          ...
                                          className="w-full p-1 border border-gray-150 rounded text-[11px] outline-none focus:border-indigo-500 text-center"
                                          placeholder="e.g. 🍵"
                                        />
                                      </div>
                                    )}
                                    ...
                                    {page.layout === 'specials' && (
                                      <div>
                                        <label className="block text-gray-400 font-bold mb-0.5 text-[9px] uppercase">Button Text</label>
                                        <input 
                                          type="text"
                                          value={item.btnLabel || ''}
                                          onChange={(e) => {
                                  ...
                                  {page.layout === 'specials' && (
                                    <div>
                                      <label className="block text-gray-400 font-bold mb-0.5 text-[9px] uppercase">Card Image URL</label>
                                      <input 
                                        type="text"
                                        value={item.image || ''}
                                        onChange={(e) => {
                                  ...
                                  <div>
                                    <label className="block text-gray-400 font-bold mb-0.5 text-[9px] uppercase">Description</label>
                                    <textarea 
                                      value={item.desc || ''}
                                      onChange={(e) => {
                                      ...
                                      rows={2}
                                      className="w-full p-1 border border-gray-150 rounded text-[11px] outline-none focus:border-indigo-500 resize-y"
                                    />
                                  </div>
                                </div>
                              ))}
                              {page.items.length === 0 && (
                                <p className="text-gray-400 italic text-[11px] text-center py-3">No cards configured. Add one above.</p>
                              )}
                            </div>
                          </div>
                        )}
            ...
            <div className="border-t border-gray-100 pt-4 space-y-3.5">
              <h4 className="font-bold text-gray-700">✦ Create New Page</h4>
              
              <div>
                <label className="block text-gray-500 font-bold mb-1 uppercase text-[10px]">Page Title</label>
                <input 
                  type="text" 
                  id="new-page-title" 
                  placeholder="e.g. Menu, Special Offers" 
                  className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs outline-none focus:ring-1 focus:ring-purple-500" 
                />
              </div>

              <div>
                <label className="block text-gray-500 font-bold mb-1 uppercase text-[10px]">Page Layout Style</label>
                <select 
                  id="new-page-layout"
                  className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs outline-none focus:ring-1 focus:ring-purple-500 font-bold"
                >
