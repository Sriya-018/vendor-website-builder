...
import { getTemplateGallery } from '../utils/galleryDefaults';
...
function WebsiteEditor() {
 ...
 const templateName = siteData.template || 't1';
 mergedConfig.gallery = {
 ...DEFAULT_CONFIG.gallery,
 images: getTemplateGallery(templateName)
 };
 ...
 const templateName = siteData.template || 't1';
 const defaultGalleryImages = getTemplateGallery(templateName);
 ...
 className={`p-2 rounded-lg transition-colors ${devicePreview === 'desktop' ? 'bg-white dark:bg-[#13121A] shadow-sm text-purple-650 dark:text-purple-700 dark:text-purple-400' : 'text-slate-600 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-700 dark:text-slate-300'}`}
 title="Desktop"
 >
 <FaDesktop />
 </button>
 ...
 className={`p-2 rounded-lg transition-colors ${devicePreview === 'tablet' ? 'bg-white dark:bg-[#13121A] shadow-sm text-purple-650 dark:text-purple-700 dark:text-purple-400' : 'text-slate-600 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-700 dark:text-slate-300'}`}
 title="Tablet"
 >
 <FaTabletAlt />
 </button>
 ...
 className={`p-2 rounded-lg transition-colors ${devicePreview === 'mobile' ? 'bg-white dark:bg-[#13121A] shadow-sm text-purple-650 dark:text-purple-700 dark:text-purple-400' : 'text-slate-600 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-700 dark:text-slate-300'}`}
 title="Mobile"
 >
 <FaMobileAlt />
 </button>
 ...
 className="flex items-center gap-2 text-slate-700 dark:text-slate-700 dark:text-slate-300 bg-white dark:bg-[#13121A] border border-slate-200 dark:border-slate-700/60 hover:bg-slate-50 dark:hover:bg-[#1A1924] px-4 py-2 rounded-xl font-bold transition-all text-sm"
 >
