...
function Landing({ token, setToken, setBusinessId }) {
 ...
 return (
 <div className={`min-h-screen font-sans transition-colors duration-300 theme-${theme} ${theme === 'dark' ? 'bg-slate-50 dark:bg-[#09080E] text-slate-100' : 'bg-[#F8FAFC] text-slate-800'} relative overflow-hidden`}>
 ...
 {/* Navbar */}
 <nav className={`${theme === 'dark' ? 'bg-slate-50 dark:bg-[#09080E]/85 border-slate-200 dark:border-slate-800/80' : 'bg-white/85 border-slate-200'} border-b backdrop-blur-md sticky top-0 z-50`}>
 ...
 {token ? (
 <>
 <button onClick={() => navigate('/templates')} className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white font-medium transition-colors">Templates</button>
 <button onClick={() => navigate('/dashboard')} className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white font-medium transition-colors">Dashboard</button>
 <button onClick={handleLogout} className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-red-400 font-medium transition-colors">
 <FaSignOutAlt /> Logout
 </button>
 </>
 ) : (
 ...
 <button onClick={() => navigate('/admin')} className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white font-medium transition-colors">Admin Panel</button>
 </>
 )}
 </div>
 ...
 <ThemeToggle />
 <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white focus:outline-none">
 ...
 {/* Mobile menu */}
 {isMobileMenuOpen && (
 <div className="md:hidden bg-white dark:bg-[#0D0C14] border-b border-slate-200 dark:border-slate-800 px-4 pt-2 pb-4 space-y-1 shadow-xl absolute w-full z-50">
 {token ? (
 <>
 <button onClick={() => { setIsMobileMenuOpen(false); navigate('/templates'); }} className="w-full text-left px-3 py-2 text-base font-medium text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-850 rounded-md">Templates</button>
 <button onClick={() => { setIsMobileMenuOpen(false); navigate('/dashboard'); }} className="w-full text-left px-3 py-2 text-base font-medium text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-850 rounded-md">Dashboard</button>
 ...
 <>
 <a href="#features" className="block px-3 py-2 text-base font-medium text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-850 rounded-md">Features</a>
 <a href="#how-it-works" className="block px-3 py-2 text-base font-medium text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-850 rounded-md">How it Works</a>
 <button onClick={() => { setIsMobileMenuOpen(false); navigate('/admin'); }} className="w-full text-left px-3 py-2 text-base font-medium text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-850 rounded-md">Admin Panel</button>
 <button
 onClick={() => {
 ...
 <div id="login" className="w-full bg-white dark:bg-[#13121A] border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl p-8 relative overflow-hidden">
 <div className="absolute -top-12 -right-12 w-24 h-24 bg-purple-600/10 rounded-full blur-xl pointer-events-none"></div>
 ...
 <div className="flex items-center border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#09080E] focus-within:ring-2 focus-within:ring-purple-500 focus-within:bg-white dark:bg-[#13121A] focus-within:border-transparent rounded-xl overflow-hidden transition-all">
 <span className="bg-slate-100 dark:bg-[#181720] text-slate-600 dark:text-slate-400 px-4 py-3.5 border-r border-slate-200 dark:border-slate-800 font-semibold">+91</span>
 <input
 type="tel"
 value={phone}
 ...
 <div className="flex items-center border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#09080E] focus-within:ring-2 focus-within:ring-purple-500 focus-within:bg-white dark:bg-[#13121A] focus-within:border-transparent rounded-xl overflow-hidden transition-all">
 <div className="bg-slate-100 dark:bg-[#181720] text-slate-600 dark:text-slate-400 px-4 py-3.5 border-r border-slate-200 dark:border-slate-800">
 <FaEnvelope />
 </div>
 <input
 type="email"
 ...
 <p className="text-[10px] text-center text-slate-600 dark:text-slate-500">By continuing, you agree to our Terms of Service.</p>
 </div>
 ) : (
 <div className="space-y-6">
 <div>
 ...
 className="w-full border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#09080E] rounded-xl p-4 text-center text-xl outline-none focus:ring-2 focus:ring-purple-500 focus:bg-white dark:bg-[#13121A] text-slate-900 dark:text-white mb-4 font-semibold"
 />
 </>
 )}
 ...
 <p className="mt-4 max-w-2xl text-base text-slate-600 dark:text-slate-400 mx-auto leading-relaxed">
 ...
 {/* Feature 1 */}
 <div className="dark-card bg-white dark:bg-gradient-to-b dark:from-[#161424]/90 dark:to-[#0D0C14]/90 p-8 rounded-3xl border border-slate-200 dark:border-slate-800/80 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/5 hover:-translate-y-1.5 transition-all duration-300 group backdrop-blur-md">
 ...
 {/* Feature 3 */}
 <div className="dark-card bg-white dark:bg-gradient-to-b dark:from-[#161424]/90 dark:to-[#0D0C14]/90 p-8 rounded-3xl border border-slate-200 dark:border-slate-800/80 hover:border-pink-500/50 hover:shadow-2xl hover:shadow-pink-500/5 hover:-translate-y-1.5 transition-all duration-300 group backdrop-blur-md">
 ...
 {/* Step 1 */}
 <div className="dark-card flex flex-col items-center lg:items-start text-center lg:text-left bg-white dark:bg-gradient-to-b dark:from-[#161424]/90 dark:to-[#0D0C14]/90 p-8 rounded-3xl border border-slate-200 dark:border-slate-800/80 hover:border-indigo-500/50 hover:shadow-2xl hover:shadow-indigo-500/5 transition-all duration-300 relative group backdrop-blur-md z-10 hover:-translate-y-1.5">
 ...
 <div className="dark-card mt-20 bg-white dark:bg-gradient-to-b dark:from-[#13121A] dark:to-[#09080E] border border-slate-200 dark:border-slate-800/80 rounded-3xl p-8 md:p-12 shadow-sm relative overflow-hidden backdrop-blur-md">
 ...
 <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-8 tracking-wide">Inside the Technology: How It Works</h3>
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
 <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/30 border border-slate-200 dark:border-slate-800/60 hover:border-indigo-500/30 transition-colors">
 ...
 <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/30 border border-slate-200 dark:border-slate-800/60 hover:border-purple-500/30 transition-colors">
 <h4 className="font-bold text-sm text-slate-900 dark:text-white mb-3 flex items-center gap-2">
 ...
 <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/30 border border-slate-200 dark:border-slate-800/60 hover:border-pink-500/30 transition-colors">
 <h4 className="font-bold text-sm text-slate-900 dark:text-white mb-3 flex items-center gap-2">
 ...
 {/* Footer */}
 <footer className="bg-slate-50 dark:bg-[#09080E] border-t border-slate-200 dark:border-slate-800/80 py-12 relative z-10">
